class Blog::ApplicationController < ApplicationController
  ...
  layout Rails.application.config.layout if Rails.application.config.layout # TODO: find a way to test that. It was asked in issue #54 (https://github.com/jipiboily/blog/issues/54)
